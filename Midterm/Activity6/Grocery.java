...
public class Grocery {
    ...
    public static class Customer {
        ...
        public void enterName() {
            String name = new InputField("Enter customer name : ")
                    .min(3)
                    .onlyAlphabetic()
                    .nextString();
            this.name = name;
        ...
        public boolean checkOut() {
            ...
            while (pay < cart.getTotal()) {
                pay = new InputField("Enter Payment : ")
                        .nextDouble();
    ...
    public static class Cart {
        ...
        public void removeItem() {
            while (true) {
                ...
                itemString += "\n";
                // choice check
                int choice = new InputField(itemString + "Choice : ")
                        .min(0)
                        .max(items.size() - 1)
                        .nextInt();
                // quantity check
                int quantity = new InputField("Quantity : ")
                        .min(1)
                        .nextInt();
    ...
    public static class Storage {
        ...
        public void shopProducts(Cart cart, Storage store) {
            ...
            while (true) {
                displayProducts();
                int choice = new InputField("Choice : ")
                        .min(0)
                        .max(products.size() - 1)
                        .nextInt();
                int quantity = new InputField("Enter quantity : ")
                        .nextInt();
    ...
    public static void main(String[] args) {
        InputField.setGlobalNoPauseOnError();
