public class Enrollment {
    ...
    public static void main(String[] args) {
        ...
        while (active) {
            ...
            String fName = new InputField("First  Name : ").min(3).onlyAlphabetic().nextString();
            String mName = new InputField("Middle Name : ").min(3).onlyAlphabetic().nextString();
            String lName = new InputField("last Name   : ").min(3).onlyAlphabetic().nextString();
            System.out.println();
            String gender = new InputField("Gender      : ")
