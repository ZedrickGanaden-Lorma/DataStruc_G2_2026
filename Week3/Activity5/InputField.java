...
public class InputField {
    ...
    // Limits
    // - Numeral
    public InputField min(double min) {
        hasMin = true;
        this.min = min;
        return this;
    }

    public InputField max(double max) {
        hasMax = true;
        this.max = max;
        return this;
    }
    ...
    public InputField onlyNumeric() {
        onlyAlphabetic = false;
        onlyNumeric = true;
        return this;
    }

    public InputField onlyAlphabetic() {
        onlyNumeric = false;
        onlyAlphabetic = true;
        return this;
    }

    public InputField setAllowedChars(char[] allowed) {
        this.allowedChars = allowed;
        return this;
    }

    public InputField setAllowedChars(String allowed) {
    ...
    public InputField noPauseOnError() {
    ...
    /// Sets the value variable of the {@link #Input} Class to a float after being
    /// validated by the enabled checks, any error detected by these checks will
    /// return the user to the start
    /// 
    /// Checks used by this method
